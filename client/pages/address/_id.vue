                ...
                <div class="a-spacing-medium a-spacing-top-medium">
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <input type="text" class="a-input-text" style="width: 100%;"
                           v-model="city" :placeholder="address.city"/>
                  </div>
                  <!-- State -->
                  <div class="a-spacing-top-medium">
                    <label style="margin-bottom: 0px;">State / Province / Region</label>
                    <input type="text" class="a-input-text" style="width: 100%;"
                           v-model="state" :placeholder="address.state"/>
                  </div>
                  <!-- Zip Code -->
                  <div class="a-spacing-top-medium">
                    <label style="margin-bottom: 0px;">Zip Code</label>
                    <input type="text" class="a-input-text" style="width: 100%;"
                           v-model="zipCode" :placeholder="address.zipCode"/>
                  </div>
                  <!-- Phone Number -->
                  <div class="a-spacing-top-medium">
                    <label style="margin-bottom: 0px;">Phone Number</label>
                    <input type="text" class="a-input-text" style="width: 100%;"
                           v-model="phoneNumber" :placeholder="address.phoneNumber"/>
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <input type="text" class="a-input-text" style="width: 100%;"
                           v-model="securityCode" :placeholder="address.securityCode"/>
                  </div>
                  <div class="a-spacing-top-medium">
