    ...
    <div class="shipping-address">
                ...
                <div class="a-row">
                  ...
                  <div class="order-summary" style="font-size: 12px;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">
                        <!-- Total Price with Shipping -->
                        <div class="a-color-price a-size-medium a-text-bold">USD {{ getCartTotalPriceWithShipping }}
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="a-box-inner">
                ...
                <div class="a-size-mini">
                  <div class="a-row a-spacing-mini mb-1">
                    Please note that your country may charge import duties, taxes and fees that you may have to pay
                    ahead of delivery.
                    <a
                      href="#"
                    >Learn more</a>
      ...
      <div class="a-row a-spacing-small a-spacing-top-small">
        ...
        >For an item sold by Amazon.com: When you click the "Place your order" button, we'll send you an email message
          acknowledging receipt of your order. Your contract to purchase an item will not be complete until we send you
          an email notifying you that the item has been shipped.</p>
        ...
        <div class="a-color-secondary a-size-mini">
          <p class="a-color-secondary a-size-mini">
            Within 30 days of delivery, you may return new, unopened merchandise in its original condition. Exceptions
            and restrictions apply. See Amazon.com's
            <a
              href="#"
            >Returns Policy</a>
            <br/>
